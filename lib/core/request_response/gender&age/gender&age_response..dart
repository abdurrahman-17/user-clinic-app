...
//
//     final addGenderAge = addGenderAgeFromJson(jsonString);

import 'dart:convert';

AddGenderAge addGenderAgeFromJson(String str) => AddGenderAge.fromJson(json.decode(str));

String addGenderAgeToJson(AddGenderAge data) => json.encode(data.toJson());
...
class AddGenderAge {
  ...
  factory AddGenderAge.fromJson(Map<String, dynamic> json) => AddGenderAge(
