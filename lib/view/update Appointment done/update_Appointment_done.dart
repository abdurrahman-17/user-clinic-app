...
class update_Appointment_done extends StatefulWidget {
  final name;
  final age;
  final time;
  final date;
  ...
  final drimage;
  final draddress;
  const update_Appointment_done({Key? key,required this.name,required this.age, required this.time, required this.date, required this.drname, required this.drspec,required this.drimage,required this.draddress}) : super(key: key);

  @override
  _update_Appointment_doneState createState() => _update_Appointment_doneState();
}

class _update_Appointment_doneState extends State<update_Appointment_done> {
  String utcDate='';
  @override
  void initState() {
