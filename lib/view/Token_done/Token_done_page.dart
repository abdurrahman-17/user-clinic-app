...
class token_done_page extends StatefulWidget {
  ...
  final drimage;
  final draddress;
   token_done_page({Key? key, required this.name,required this.age,required this.time,required this.date,required this.drname,required this.drspec,required this.drimage,required this.draddress,required this.token}) : super(key: key);
