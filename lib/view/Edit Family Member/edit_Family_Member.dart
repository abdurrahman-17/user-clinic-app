...
class Edit_Family_Member extends StatefulWidget {
  final id;
  final name;
  final images;
  final age;
  final gender;
   Edit_Family_Member({Key? key,required this.id,required this.name,required this.images,required this.age,required this.gender, }) : super(key: key);

  @override
  _Edit_Family_MemberState createState() => _Edit_Family_MemberState();
}

class _Edit_Family_MemberState extends State<Edit_Family_Member> {
  int? _result;
//  bool _isEditingText = false;
  ...
  int age = -1;
  String Gen='';
  UpdateFamilyProfileNotifier? updateFamilyProfileNotifier;
  ...
  void initState() {
    setState(() {
      ...
      print(widget.id);
      print(widget.gender);
      _editingController.text=widget.name.toString();
  ...
  Widget build(BuildContext context) {
    if (!kReleaseMode) {}
    return Consumer<UpdateFamilyProfileNotifier>(
  ...
  Widget buildSaveButton(BuildContext context){
    ...
    Provider.of<UpdateFamilyProfileNotifier?>(context, listen: false)!;
    return Padding(
          ...
          child: Builder(
            builder: (context) {
              return ElevatedButton(onPressed: (){
                ...
                print(Gen);
                //print(filename);
                if(_key.currentState!.validate()&&_age.text.isNotEmpty){
                  updateFamilyProfileNotifier!.familyUpdateProfile(widget.id,_editingController.text,calc.text.isEmpty?_age.text:calc.text, Gen,_images_profile.toString(),filename.toString());
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              ...
              child: _image != null
                ...
                borderRadius: BorderRadius.circular(50),
                child: Image.network(
                  DataConstants.LIVE_BASE_URL+'/'+widget.images,
                  width: 100,
                  height: 100,
                  fit: BoxFit.fill,
                ),
  ...
  Widget backButton(context) {
    return Row(
      children: [
        ...
        Spacer(),
        Padding(
          padding:  EdgeInsets.only(top: MediaQuery.of(context).size.height*0.031,right: 15),
          child: Align(
              alignment: Alignment.topLeft,
              child: Text('Edit Family Member',style: ProfileStyle(context))),
        ),
        Spacer()
      ],
    );
