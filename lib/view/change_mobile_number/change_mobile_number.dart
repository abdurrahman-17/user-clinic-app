...
import 'package:user_clinic_token_app/view/change_mobile_num_confirm/change_num_confirm.dart';



class Change_mobile_setting extends StatefulWidget {
  const Change_mobile_setting({Key? key}) : super(key: key);

  @override
  State<Change_mobile_setting> createState() => _Change_mobile_settingState();
}

class _Change_mobile_settingState extends State<Change_mobile_setting> {
  @override
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text('Change Mobile Number',style: TextStyle(color: Color(0xff4889FD,),fontWeight: FontWeight.w700,fontSize: 24),),
          SizedBox(width: 10,)
        ],
      ),
    );
  ...
  Widget titleText(context) {
    return Padding(
      padding:  EdgeInsets.only(top: MediaQuery.of(context).size.height * 0.25,left: 15),
      child: Text(
          'Enter Password',
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
               if (_key.currentState!.validate()) {
                Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>Change_new_number(password:_password.text)));
               }
            },
          ),
        ),
