...
class Toke_Appointment_New extends StatefulWidget {
  const Toke_Appointment_New({Key? key}) : super(key: key);

  @override
  _Toke_Appointment_NewState createState() => _Toke_Appointment_NewState();
}
class Tech {
  String label;
  bool isSelected;
...
class _Toke_Appointment_NewState extends State<Toke_Appointment_New> {

  get_Doctor_Token_Schedule_Notifier provider=get_Doctor_Token_Schedule_Notifier();
   add_Token_Appointment_Notifier provider1=add_Token_Appointment_Notifier();
          ...
          builder: (context) {
            return ElevatedButton(onPressed: (){
              ...
              if(selected.isEmpty){
                ...
                Scaffold.of(context).showSnackBar(new SnackBar(content: Text('Please Write Your Problem')));
              }else{
