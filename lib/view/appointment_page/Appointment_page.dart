...
class New_appointment extends StatefulWidget {
  ...
  @override
  _New_appointmentState createState() => _New_appointmentState();
}
...
class _New_appointmentState extends State<New_appointment> {
  ...
  add_Appointment_Notifier provider1 = add_Appointment_Notifier();
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      provider.get_Doctor_Schedule(
          widget.id, outputDate, id, outputDatedate.toString());
  ...
  Widget build(BuildContext context) {
    return Consumer<add_Appointment_Notifier>(
  ...
  Widget _buildBody(BuildContext context,add_Appointment_Notifier providers) {
            ...
            child: IntrinsicHeight(
              child: Column(
                ...
                children: [
                  ...
                  // buildAge(context),
                  // buildGender(context),
                  Form(key: _key, child: buildWriteProblem(context)),
  ...
  Widget buildButton(BuildContext context,add_Appointment_Notifier providers) {
    return Padding(
          ...
          return ElevatedButton(
                  onPressed: () {
                    ...
                    if (selected.isEmpty) {
                      ...
                      Scaffold.of(context).showSnackBar(
                          new SnackBar(content: Text('Please Write Your Problem')));
                    } else {
                      final pateint_id = int.parse(selectedValue!);
                      print(selectedValue);
                      providers.Add_Appointment_class(
                          widget.id,
                          outputDate,
                          pateint_id,
